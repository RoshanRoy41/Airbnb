document.addEventListener("DOMContentLoaded", function () {
  ...
  signUpForm.addEventListener("submit", function (event) {
    ...
    var profession = document.getElementById("phone").value;
  ...
  function submitForm() {
    var scriptURL =
      "https://script.google.com/macros/s/AKfycbyMR2j8nCu9_lUVc2KMs66_MmiH7DgCrHifoWDjXRgFCEB6Jw39SZxS8E_pT6E2pwii1Q/exec";
